...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        <div class="card">
            <form method="POST" action="{{ route('dashboard.pengacara.update', $item->id) }}">
                @csrf
                @method('put')
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="nama_pengacara" name="nama_pengacara" class="form-control"
                                    value="{{$item->nama_pengacara}}" placeholder="Nama Pengacara" required>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="nomor_telepon" name="nomor_telepon" class="form-control"
                                    value="{{$item->nomor_telepon}}" placeholder="Nomor Telepon Pengacara" required>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="alamat_pengacara" name="alamat_pengacara" class="form-control"
                                    value="{{$item->alamat_pengacara}}" placeholder="Almat Pengacara" required>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" id="email_pengacara" name="email_pengacara" class="form-control"
                                    value="{{$item->email_pengacara}}" placeholder="Email Pengacara " required>
                            </div>
                        </div>
                    </div>
                </div>
